...
# This file contains the model structures that we fit for the first part of the paper. 
# The data used to fit the model are from WDFW surveys of egg biomass. They are available from the WDFW from their most recent stock status report:
